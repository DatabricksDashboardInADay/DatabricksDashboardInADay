...
CREATE OR REPLACE MATERIALIZED VIEW ${gold_schema}.fact_coffee_sales
...
FROM ${silver_schema}.fact_coffee_sales fcs
JOIN ${silver_schema}.dim_product dp
  ON fcs.product_key = dp.product_key
JOIN ${silver_schema}.dim_store ds
